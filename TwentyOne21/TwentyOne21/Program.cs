...
namespace TwentyOne
{
    class Program
    {
        ...
        private static void UpdateDbWithException(Exception ex)
        {
            ...
            string queryString = @"INSERT INTO Exceptioins (ExceptionType, ExceptionMessage, TimeStamp) VALUES
        ...
        private static List<ExceptionEntity> ReadExceptions()
        {
            ...
            string queryString = @"Select Id, ExceptionType, ExceptionMessage, TimeStamp From Exceptioins";
